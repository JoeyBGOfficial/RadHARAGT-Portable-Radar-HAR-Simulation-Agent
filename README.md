...
| 2026.4.30 | RadHARSimulator V3.2 (Main_MIMO_Multiperson.m, RadHARAGT.mlapp) | Add MIMO radar system support, multi-person support, and simple indoor scatterer-based object supoort. Design the complete simulation GUI interface for the agent. |
